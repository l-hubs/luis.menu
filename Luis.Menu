...
local Window = OrionLib:MakeWindow({Name = "Luis.Menu", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Luis.Menu"})

OrionLib:MakeNotification({
	Name = "Luis.Menu",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://80007213190988",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://80007213190988",
    PremiumOnly = false
})
